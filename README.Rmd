...
-  path to the compressed and indexed file of contacts. Both local and remote (via URI) data retrieval are supported. More about the required format in the file format [section](File format).
...
hicvidere only needs the upper triangular contact matrix (so *row* position >= *col* position).
